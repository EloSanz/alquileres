export class Tax {
  ...
  validate(): string[] {
    ...
    if (!this.taxType) errors.push('Tax type is required');
    return errors;
  }
...
export class CreateTax {
  ...
  static fromJSON(data: any): CreateTax {
...
export class UpdateTax {
  ...
  toJSON() {
    ...
    if (this.taxType !== undefined) result.taxType = this.taxType;
  ...
  static fromJSON(data: any): UpdateTax {
